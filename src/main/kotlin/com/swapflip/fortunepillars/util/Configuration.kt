...
object Configuration : Config(PaperConfigProvider()) {
    ...
    var queueWorldName by custom("queue.world", PPEntryTypes.placeholder, PlaceholderNameGetter("FortunePillars"))
    ...
    fun init() {
        ...
        result.second.forEach { FortunePillars.LOG.error(it) }
